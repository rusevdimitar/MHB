<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ExchangeRates.ascx.vb"
    Inherits="MHB.Web.ExchangeRates" %>
<asp:Chart ID="Chart1" runat="server" BackImageAlignment="Top" BackSecondaryColor="White"
